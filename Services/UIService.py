...
BackgroundImage = Image(
    ...
    (200, 200, 0),
    0,
    f"Assets\Background\SpaceMinesBGv3.png",
    zIndex=-1,
)
...
# Headers
SOALabel = TextLabel(
    (0.4, 0.2), (0.15, 0.05), HEADERTEXTCOLOR, 1, (255, 0, 0), "SF Pro", 1, 2
)

MarketsLabel = TextLabel(
    (0.485, 0.28), (0.1, 0.05), (255, 0, 0), 1, HEADERTEXTCOLOR, "SF Pro", 1, 2
)

DecisionsLabel = TextLabel(
    (0.65, 0.2), (0.1, 0.05), (255, 0, 0), 1, HEADERTEXTCOLOR, "SF Pro", 1, 2
)
